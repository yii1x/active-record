 ...
 * Compared with the same methods in {@link DbCommand}, these methods will display extra
...
abstract class DbMigration
{
     ...
     * @return DbConnection the currently active database connection
     * @throws Exception if "db" application component is not configured
     */
     ...
     * @param DbConnection $db the database connection component
     */
    public function setDbConnection(DbConnection $db): void
    {
        $this->_db = $db;
    }
     ...
     * @param array $params input parameters (name=>value) for the SQL execution. See {@link DbCommand::execute} for more details.
     * @since 1.1.7
     */
     ...
     * refer to {@link DbCommand::where} on how to specify conditions.
     * @param array $params the parameters to be bound to the query.
     */
    public function update(string $table, array $columns, mixed $conditions = '', array $params = []): void
    {
        echo "    > update $table ...";
        $time = microtime(true);
     ...
     * @param array $params the parameters to be bound to the query.
     */
    public function delete(string $table, mixed $conditions = '', array $params = []): void
    {
     ...
     * @since 1.1.9
     */
    public function refreshTableSchema(string $table): void
    {
