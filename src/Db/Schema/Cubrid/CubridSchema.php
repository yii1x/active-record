 ...
 * @since 1.1.16
 */
class CubridSchema extends DbSchema
{
     ...
     * @param string $name table name
     * @return CubridTableSchema driver dependent table metadata. Null if the table does not exist.
     */
    protected function loadTable($name)
    {
        $table = new CubridTableSchema;
     ...
     * @param CubridTableSchema $table the table instance
     ...
     * @param CubridTableSchema $table the table metadata
