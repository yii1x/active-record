 ...
 */
class MssqlSchema extends DbSchema
{
     ...
     * @param string $name table name
     * @return MssqlTableSchema driver dependent table metadata. Null if the table does not exist.
     */
     ...
     * @param MssqlTableSchema $table the table instance
     ...
     * @param MssqlTableSchema $table table
