...
class MysqlSchema extends DbSchema
{
     ...
     */
    public function compareTableNames($name1, $name2): bool
    {
     ...
     * @param string $name table name
     * @return MysqlTableSchema driver dependent table metadata. Null if the table does not exist.
     */
    protected function loadTable($name): ?MysqlTableSchema
    {
     ...
     * @return MysqlCommandBuilder command builder instance
     * @since 1.1.13
     */
    protected function createCommandBuilder(): MysqlCommandBuilder
    {
    ...
    public function renameColumn($table, $name, $newName)
    {
        ...
        if ($row === false)
            throw new DbException(sprintf('Unable to find "%s" in table "%s".', $name, $table));
