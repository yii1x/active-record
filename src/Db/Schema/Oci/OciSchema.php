...
namespace Yii1x\ActiveRecord\Db\Schema\Oci;
 ...
 */
class OciSchema extends DbSchema
{
    ...
    {
        return new OciCommandBuilder($this);
    }
     ...
     * @param OciTableSchema $table the table instance
     ...
     * @param OciTableSchema $table the table metadata
