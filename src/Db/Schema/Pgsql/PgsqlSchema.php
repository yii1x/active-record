 ...
 * @since 1.0
 */
class PgsqlSchema extends DbSchema
{
     ...
     * @param string $name table name
     * @return DbTableSchema driver dependent table metadata.
     */
    protected function loadTable($name): ?DbTableSchema
    {
     ...
     * @param PgsqlTableSchema $table the table instance
...
EOD;
     ...
     * @return PgsqlCommandBuilder command builder instance.
     */
    protected function createCommandBuilder(): PgsqlCommandBuilder
    {
