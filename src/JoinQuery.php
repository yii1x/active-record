...
class JoinQuery
{
     ...
     * @param DbCommandBuilder $builder the command builder
     * @return DbCommand DB command instance representing the SQL statement
     */
    public function createCommand($builder)
    {
        ...
        foreach ($this->groups as $group)
            if ($group !== '') {
                $groups = array_merge($groups, (array)$group);
            }
        if ($groups !== [])
